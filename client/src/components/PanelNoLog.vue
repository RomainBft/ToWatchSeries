  ...
  <div class="panel-global" id="nolog">
    ...
    <div class="panel-listing">
      ...
      <svg  id="homeBg" width="868" height="1048" viewBox="0 0 868 1048" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect opacity="0.01" y="1006" width="554" height="94" rx="20" fill="#190D2F"/>
        <rect opacity="0.15" x="86" y="896" width="554" height="94" rx="20" fill="#190D2F"/>
        <rect opacity="0.2" x="314" y="784" width="554" height="94" rx="20" fill="#190D2F"/>
        <rect opacity="0.05" y="672" width="554" height="94" rx="20" fill="#190D2F"/>
        <rect opacity="0.2" x="86" y="560" width="554" height="94" rx="20" fill="#190D2F"/>
        <rect opacity="0.1" x="314" y="448" width="554" height="94" rx="20" fill="#190D2F"/>
        <rect opacity="0.05" y="336" width="554" height="94" rx="20" fill="#190D2F"/>
        <rect opacity="0.15" x="86" y="224" width="554" height="94" rx="20" fill="#190D2F"/>
        <rect opacity="0.1" x="314" y="112" width="554" height="94" rx="20" fill="#190D2F"/>
        <rect opacity="0.05" width="554" height="94" rx="20" fill="#190D2F"/>
      </svg>
...
export default {
  ...
  async mounted () {
    if (this.$store.state.isUserLoggedIn === true) {
      ...
      this.series = (await SeriesService.getSeries(user)).data
    } else {
      this.h1Pos()
  ...
  methods: {
    h1Pos() {
      ...
      const textlog = document.getElementsByClassName('text-log')[0]
