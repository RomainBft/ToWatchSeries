...
export default {
  ...
  async mounted () {
    ...
    tl.set('.item-options', {opacity: 0, y: 0, height: 0, marginTop: 0})
      ...
      .fromTo(itemOptions, {opacity: 0, y: 0, height: 0, marginTop: 0}, {opacity: 1, y: -10, height: "auto", marginTop: 25, duration: 0.25})
      ...
      .fromTo(itemOptions, {opacity: 1, y: -10, height: "auto", marginTop: 25}, {opacity: 0, y: 0, height: 0, marginTop: 0, duration: 0.25})
